...
const handleContinueTiffin = (booking: any) => {
  const params = {
    bookingId: booking._id,
    type: "tiffin",
    serviceId: booking.tiffinServiceId,        
    
  };

  console.log("Tiffin → Checkout Params:", params);
  router.push({
...
const handleContinueHostel = (booking: any) => {
  const params = {
    bookingId: booking._id,
    type: "hostel",
    serviceId: booking.hostelId?._id,        
   
  };

  console.log("Hostel → Checkout Params:", params);
  router.push({
    pathname: "/(secure)/check-out",
    params,
  });
  ...
  <PendingTiffinCard 
    booking={item} 
    onContinue={() => handleContinueTiffin(item)}
  ...
  const renderHostelItem = ({ item }: { item: any }) => (
    <PendingHostelCard 
      booking={item} 
      onContinue={() => handleContinueHostel(item)} 
