...
export default function AddMoneyScreen() {
    ...
    const appendDigit = (d: number) => {
        setAmountStr((prev) => {
            ...
            if (prev.length >= 9) return prev; // simple cap
    ...
    return (
        <SafeAreaView style={styles.safe}>
            ...
            <View style={{ backgroundColor: 'rgba(242, 237, 237, 0.6)', position: 'absolute', bottom: insets.bottom ? insets.bottom : 0, right: 0, left: 0 }}>
                {/* Selected card row */}
...
function Key({
    ...
    return (
        <Pressable
            ...
            style={({ pressed }) => [
                styles.key,
                ghost && styles.keyGhost,   // 👈 apply transparent style
