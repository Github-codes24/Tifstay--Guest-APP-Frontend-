...
const DepositScreen = () => {
    ...
    const fetchDepositAmount = async () => {
        try {
            ...
            setDepositAmount(0); // error पर भी 0 दिखाओ, लेकिन loader हट जाएगा
        }
    };
    ...
    useFocusEffect(
        useCallback(() => {
            // Reset to loading state when screen comes into focus
    ...
    const onRefresh = useCallback(async () => {
        setRefreshing(true);
        setDepositAmount(null); // refresh पर भी loader दिखाओ
        await Promise.all([
            fetchDepositAmount(),
            fetchDepositTransactions(),
        ]);
            ...
            <KeyboardAwareScrollView enableOnAndroid extraScrollHeight={80}>
                ...
                >
                    ...
                    <View style={styles.depositBox}>
                        ...
                        {/* Loader या Amount */}
                        {depositAmount === null ? (
                            <View style={styles.amountLoaderContainer}>
