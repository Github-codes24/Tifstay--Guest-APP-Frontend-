...
const [transcript, setTranscript] = useState("");
  ...
  const fetchTiffinServicesQuery = async (): Promise<TiffinService[]> => {
    ...
    const url = `${BASE_URL}/api/guest/tiffinServices/getAllTiffinServices?${params.toString()}`;
    try {
      const response = await fetch(url, { headers });
      const result = await response.json();
  ...
  const fetchCitiesQuery = async (): Promise<string[]> => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/api/guest/hostelServices/getCitiesFromHostelServices`,
        { headers }
      );
      const result = await response.json();
  ...
  const fetchHostelTypesQuery = async (): Promise<string[]> => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/api/guest/hostelServices/getHostelTypes`,
        { headers }
      );
      const result = await response.json();
  ...
  const fetchRoomTypesQuery = async (): Promise<string[]> => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/api/guest/hostelServices/getRoomTypes`,
        { headers }
      );
      const result = await response.json();
  ...
  const fetchSuggestionsQuery = useCallback(async (): Promise<string[]> => {
    ...
    try {
      const url = isHostel
        ? `${BASE_URL}/api/guest/hostelServices/getHostelSuggestions`
        : `${BASE_URL}/api/guest/tiffinServices/getTiffinSuggestions`;
      const response = await fetch(url, { headers });
      const result = await response.json();
