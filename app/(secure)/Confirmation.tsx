...
const Confirmation: React.FC = () => {
  ...
  const tiffinBookingDetails = tiffinDetails ? {
    ...
    itemDesc: `${tiffinDetails.foodType || 'Veg'} ${tiffinDetails.orderType || 'Delivery'} ${tiffinDetails.mealType || 'Lunch'}`,
    qty: 1,
   ...
   itemDesc: `${paramFoodType || 'Veg'} ${paramOrderType || 'Delivery'} ${paramMealType || 'Lunch'}`,
    qty: 1,
